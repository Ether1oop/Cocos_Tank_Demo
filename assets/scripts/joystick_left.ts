import { _decorator, Component, Node, CCObject, EventTouch, UITransform, v3, Vec3, Vec2 } from 'cc';
const { ccclass, property } = _decorator;

@ccclass('joystick_left')
export class joystick_left extends Component {
    @property
    max_R: number = 30;
